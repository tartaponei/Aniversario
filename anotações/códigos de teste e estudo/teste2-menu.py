...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        #muda o texto do label quando a opção for escolhida
    ...
    #função pra mudar o label quando a opção no menu for clicada (linha 55)
    def clicked(self, text):
        self.label.setText(text) #muda o texto do label pro que foi passado como parâmetro
        self.label.adjustSize() #ajusta o tamanho do label em relação ao texto?
